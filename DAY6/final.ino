...
void loop() {
  ...
  stop_motor();
  missiontime=millis();
  while((millis()-missiontime)< 40000 ){
  ...
  if (blocks) {
    ...
    Serial.print(blocks);
    Serial.print("\n");
    turnright_speedright= (((pixy.ccc.blocks[0].m_x - 157)*40)/157) +51;
    turnright_speedleft= (((pixy.ccc.blocks[0].m_x - 157) *40)/157) +45;
    turnleft_speedright= (((157 - pixy.ccc.blocks[0].m_x)*40)/157) +61;
    turnleft_speedleft= (((157 - pixy.ccc.blocks[0].m_x) *40)/157) +35;
    //(pixy.ccc.blocks[0].m_width >= 90)
    if ((pixy.ccc.blocks[0].m_x > 137) && (pixy.ccc.blocks[0].m_x < 177) && (pixy.ccc.blocks[0].m_y > 180)&&(pixy.ccc.blocks[0].m_y > 60)) {
    ...
    else if (pixy.ccc.blocks[0].m_x > 137 && pixy.ccc.blocks[0].m_x < 177 && pixy.ccc.blocks[0].m_width < 180 && (pixy.ccc.blocks[0].m_y > 60)) {
      Serial.print("go straight\n");
      go_straight();
      delay(50);
      stop_motor();
    }
    else if ((pixy.ccc.blocks[0].m_y > 40)&&(pixy.ccc.blocks[0].m_x > 177)) {
    ...
    else if ((pixy.ccc.blocks[0].m_y > 40)&&(pixy.ccc.blocks[0].m_x < 137)){
  ...
  while(1){    
    ...
    if (blocks) {
      ...
      Serial.print(blocks);
      Serial.print("\n");
    turnright_speedright= (((pixy.ccc.blocks[0].m_x - 157)*50)/157) +51;
    turnright_speedleft= (((pixy.ccc.blocks[0].m_x - 157) *50)/157) +50;
    turnleft_speedright= (((157 - pixy.ccc.blocks[0].m_x)*50)/157) +66;
    turnleft_speedleft= (((157 - pixy.ccc.blocks[0].m_x) *50)/157) +35;
      //(pixy.ccc.blocks[0].m_width >= 90)
      if ((pixy.ccc.blocks[0].m_x > 137) && (pixy.ccc.blocks[0].m_x < 177) && (pixy.ccc.blocks[0].m_y > 180) && (pixy.ccc.blocks[0].m_y > 20)) {
      ...
      else if ((pixy.ccc.blocks[0].m_x > 137 && pixy.ccc.blocks[0].m_x < 177 && pixy.ccc.blocks[0].m_width < 180) && (pixy.ccc.blocks[0].m_y > 20)) {
        Serial.println("go straight\n");
        go_straight(80,96);
        delay(100);
        stop_motor();
      }
    else if ((pixy.ccc.blocks[0].m_x > 177)) {
    ...
    else if ((pixy.ccc.blocks[0].m_x < 137)){
      Serial.print("turn left\n");
      Serial.println(turnleft_speedleft);
      Serial.println(turnleft_speedright);
      turn_left(turnleft_speedleft, turnleft_speedright);
